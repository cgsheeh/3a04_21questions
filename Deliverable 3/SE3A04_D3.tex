...
\begin{figure}[H]
\includegraphics[scale=0.65]{diagrams/sd_questioncontroller}
...
\begin{figure}[H]
\includegraphics[scale=0.80]{diagrams/maintenance_of_code}
\caption{Sequence Diagram for when maintenance or updates must be preformed.}\label{sd:maintenance_of_code}
\end{figure}

\begin{figure}[H]
\includegraphics[scale=0.80]{diagrams/useCase4SeqDiag2}
...
\begin{figure}[H]
\includegraphics[scale=0.70]{diagrams/Addition_of_Expert}
...
\begin{figure}[H]
\includegraphics[scale=0.8]{diagrams/BackEndDetailedClass}
