...
\begin{longtable}{| p{.30\textwidth} | p{.70\textwidth} |}
			...
			\\ 
			\hline
			Alexandra Rahman & Wrote the system description and scenarios as well as created the use case diagram for BE4. Collaborated on the CRC cards and the analysis class diagram.
			\\
			\hline
