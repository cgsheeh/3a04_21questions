...
\begin{document}
	...
	\abstract{\begin{center}
		...
		\begin{enumerate}[\textbf{{BE}1.}]
			...
			\begin{enumerate}[\textbf{{VP1}.1}]
				...
				\begin{enumerate}
					...
					\item The system shall allow the user to answer yes or no to questions.
					\item The system shall determine the closest locations, environment and place.
					\item The system shall allow each €œexpert€ to determine the answer given the set of questions and their answers.
				\end{enumerate}
			...
			\begin{enumerate}[\textbf{{VP2}.1}]
				...
				\item TA/Prof (Management role)
				\begin{enumerate}
					\item The system shall allow developers to easily add or remove queries(entries).
				\end{enumerate}
		...
		\begin{enumerate}[{LF}1. ]
			...
			\item
			The game will appear innovative, and it should be apparent that the application was developed in 2016.
		\end{enumerate}
		% End SubSubSection
		...
		\begin{enumerate}[{PR}1. ]
			\item
			The game will require internet access to play.
		\end{enumerate}
		% End SubSubSection
		...
		\begin{enumerate}[{PR}1. ]
			\item 
			The system shall include a wide variety of locations.
		\end{enumerate}
		% End SubSubSection
		...
		\begin{enumerate}
			...
			\item
			The system should be able to be implemented on new operating systems without change.
		\end{enumerate}
		% End SubSubSection
		...
		\begin{enumerate}[{SR}1. ]
			\item 
			The system shall not lend itself vulnerable to hackers.
			\item
			The system shall only allow those with certain clearances to modify the data.
		\end{enumerate}
		% End SubSubSection
		...
		\begin{enumerate}[{LR}1. ]
			...
			\item
			The system shall meet the standards set by Canadian BLAH BLAH BLAH.
		\end{enumerate}
		% End SubSubSection
